...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e79f408764fbaa6ddc54723e71a644d8c9875c547a591b946ae1312e318c71cd.js',function(){input.required=false;search();});}
