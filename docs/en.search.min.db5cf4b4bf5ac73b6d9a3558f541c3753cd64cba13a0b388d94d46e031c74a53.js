...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b873adf5741586ac9513a9032ca1993e2056765137d998347cd9e1d974ec80f5.js',function(){input.required=false;search();});}
